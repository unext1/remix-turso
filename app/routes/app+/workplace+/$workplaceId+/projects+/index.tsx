    ...
    <div className="flex-1">
      ...
      {projects.length >= 1 ? (
        projects.map((project) => (
          <div className="grid sm:grid-cols-2 grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-4" key={project.id}>
            <CustomCard
                  ...
                  <div className="grid grid-cols-6 items-center gap-x-4 gap-y-2">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Label
                            htmlFor="defaultColumns"
                            className="text-right col-span-2 text-sm whitespace-nowrap w-fit"
                          >
                            Default Columns
                          </Label>
                        </TooltipTrigger>
